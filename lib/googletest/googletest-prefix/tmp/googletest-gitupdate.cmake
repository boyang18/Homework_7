...
execute_process(
  COMMAND "/usr/bin/git" show-ref release-1.8.0
  WORKING_DIRECTORY "/home/boyang18/Homework_7/lib/googletest/googletest-src"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 release-1.8.0
  WORKING_DIRECTORY "/home/boyang18/Homework_7/lib/googletest/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/boyang18/Homework_7/lib/googletest/googletest-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/boyang18/Homework_7/lib/googletest/googletest-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
